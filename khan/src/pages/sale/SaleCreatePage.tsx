...
import { calculatePureGoldWeightWithHarry, calculatePureGoldWeight } from "../../utils/goldUtils";
                    ...
                    try {
                        ...
                        // 2. 결제, DC, WG, 결통 상태: 결제 처리
                            ...
                            const paymentData: SalePaymentRequest = {
                                ...
                                note: row.note,
                                goldWeight: Math.abs(getSafeNumber(String(row.goldWeight))).toString(),
