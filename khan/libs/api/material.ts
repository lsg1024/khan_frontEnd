...
export const materialApi = {
    ...
    // 재질 생성
    createMaterial: async (data: Partial<MaterialDto>): Promise<ApiResponse<MaterialDto>> => {
        return apiRequest.post<MaterialDto>("product/materials", data);
    },

    // 재질 수정
    updateMaterial: async (id: string, data: Partial<MaterialDto>): Promise<ApiResponse<MaterialDto>> => {
